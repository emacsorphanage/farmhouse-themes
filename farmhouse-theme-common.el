...
(defmacro farmhouse-theme--set-faces (name palette)
  ...
  `(let* ((class '((class color) (min-colors 24)))
          ...
          (ol1 `(:weight bold :height 1.3 :foreground ,green2))
          (ol2 `(:weight bold :height 1.2 :foreground ,cyan2))
          (ol3 `(:weight bold :height 1.1 :foreground ,blue2))
          (ol4 `(:weight bold :foreground ,purple2))
          (ol5 `(:weight bold :foreground ,yellow2))
          (ol6 `(:weight bold :slant italic :foreground ,green1))
          (ol7 `(:weight bold :slant italic :foreground ,cyan2))
